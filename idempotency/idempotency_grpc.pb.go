...
func (c *idempotencyServiceClient) Check(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/IdempotencyService/check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIdempotencyServiceServer) Check(context.Context, *Request) (*Response, error) {
...
func _IdempotencyService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdempotencyServiceServer).Check(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/IdempotencyService/check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdempotencyServiceServer).Check(ctx, req.(*Request))
	}
...
var IdempotencyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "IdempotencyService",
	HandlerType: (*IdempotencyServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "check",
			Handler:    _IdempotencyService_Check_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "idempotency.proto",
}
